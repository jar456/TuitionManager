 ...
 * It first reads a line of parses it in a string tokenizer to validate input. The user can
 * add, remove, print, delete and quit using the program's command keys.
 * 
...
public class TuitionManager {
   ...
   private void add() {
      ...
      if(command.charAt(0)== 'I') { //in state
    	  ...
    	  //a part time Instate student cannot have funding. if this happens, funding is assumed
