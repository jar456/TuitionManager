/**
 * International is a subclass of Student
 * This class calculates the tuition of an international student and calls
...
public class International extends Student {
   ...
   /**
    * Calculates amount of tuition the student owes if the student is international and
    ...
    * Used to test the functionality of the methods in variables in International.java
    * 
    * @param args
    */
