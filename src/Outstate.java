/**
 * Outstate is a subclass of Student This class calculates the tuition of an
 * outstate student and calls the superclass student to assign the student
 * information
 * 
...
public class Outstate extends Student {
   ...
   /**
    * Constructor of Outstate Assigns fname, lname, credit to superclass Student
    * Assigns private variable exchange
    * 
    * @param fname    first name of student
    * @param lname    last name of student
    * @param credit   amount of credits student is taking
    * @param tristate if is from tristate area or not
    */
   ...
   /**
    * Calculates amount of tuition an Outstate student owes. returns the amount
    * owed. Overrides abstract function defined in Student.java
    * 
   ...
   /**
    * Returns the contents of the Outstate class as a String. calls the toString()
    * method in the Student superclass, then adds information specific to the
    * Outstate subclass.
    * 
    * @return A String of the information of this Outstate Student.
    */
   @Override
   ...
   /**
    * Outstate.java testbed main Used to test the functionality of the methods in
    * variables in Outstate.java
    * 
